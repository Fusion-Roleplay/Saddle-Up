    ...
    Types = {
        ...
        Food = {
            ...
            consumable_fruitsalad = {
                ...
                addgoldhealthOutter   = 0,
                Type                  = "eat",
                animationtype         = "bowl",                -- types for eat [ hand sandwich bowl canned berry ]
                description           = "Provided by Jack&Jill", -- provide a custom description for this item
            ...
            knotmeat = {
                ...
                animationtype         = "bowl",
                description           = "Provided by Jack&Jill", -- provide a custom description for this item
                model                 = "p_cuptin01x",                      -- bowl do not need object
                Drunk                 = false,
                DrunkEffect           = "MP_Downed",             -- play a light effect only when you too drunk it will increase
                UseDrunkEffect        = false,
                Drunkness             = 0.0,
            ...
            banana = {
                ...
                addgoldhealthOutter   = 0,
                Type                  = "eat",
                animationtype         = "sandwich",                  -- types for eat [ hand sandwich bowl canned berry ]
                description           = "Provided by Jack&Jill", -- provide a custom description for this item
            ...
            blueberry = {
                ...
                addgoldhealthOutter   = 0,
                Type                  = "eat",
                animationtype         = "berry",                  -- types for eat [ hand sandwich bowl canned berry ]
                description           = "Provided by Jack&Jill", -- provide a custom description for this item
            ...
            consumable_trout = {
                ...
                animationtype         = "sandwich",                  -- types for eat [ hand sandwich bowl canned berry ]
                description           = "Provided by Jack&Jill", -- provide a custom description for this item
                model                 = "p_cs_trout02x",        -- not all models will be positioned correctly
                Drunk                 = false,
                DrunkEffect           = "MP_Downed",             -- play a light effect only when you too drunk it will increase
                UseDrunkEffect        = false,
                Drunkness             = 0.0,
            ...
            consumable_veggies = {
                ...
                animationtype         = "hand",                  -- types for eat [ hand sandwich bowl canned berry ]
                description           = "Provided by Jack&Jill", -- provide a custom description for this item
                model                 = "p_carrot01x",        -- not all models will be positioned correctly
                Drunk                 = false,
                DrunkEffect           = "MP_Downed",             -- play a light effect only when you too drunk it will increase
                UseDrunkEffect        = false,
                Drunkness             = 0.0,
