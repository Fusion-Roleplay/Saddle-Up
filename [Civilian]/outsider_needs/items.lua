...
Items.Consumables = {
    Types = {
        ...
        Drinks = {
            ...
            bwb_cwc = {
                removethirst          = 0,
                removehunger          = 0, -- remove hunger when drinking alcohol?
                removestamina         = 0,
                removehealth          = 0,
                addhealth             = 0,
                addstamina            = 150,
                ...
                animationtype         = "fastdrink",
                description           = "Provided by Black Water Bakery", -- provide a custom description for this item
                model                 = "s_inv_moonshine01x",                      -- flask no need model already has builtin animation
                Drunk                 = false,
                DrunkEffect           = "MP_Downed",             -- play a light effect only when you too drunk it will increase
                UseDrunkEffect        = false,
                Drunkness             = 0,                    -- 0,20 slight drunk 0.50 medium 1.0 very drunk
                DrunkDuration         = 20,                      --miliseconds
                TimesUsed             = 3,
                amountToCool          = 0,
                cooldown              = 0,
